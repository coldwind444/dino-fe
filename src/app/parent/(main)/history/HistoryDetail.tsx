...
import { faCalendar as faCalendarSolid, faClipboardQuestion, faClock as faClockSolid, faCheck, faXmark, faUser, faGraduationCap } from "@fortawesome/free-solid-svg-icons"
        ...
        <div className="flex flex-col gap-5 p-5 h-full w-full">
            ...
            <div className="flex-1 w-full flex flex-row gap-5">
                ...
                <div className="flex flex-col gap-3 h-full w-1/3">
                    {/** Name */}
                    <div className="h-45 w-full bg-gradient-to-r from-0% to-100% 
                            from-[#23BEAA] to-[#1DA492] rounded-xl shadow-lg px-10
                            flex flex-col gap-5 text-white justify-center">
                        <h1 className="font-bold text-2xl">Đấu trường tuần 11</h1>
                        <div className="flex flex-col gap-2 w-2/3">
                            <div className="flex flex-row items-center text-white text-sm font-bold w-full justify-between">
                            ...
                            <div className="flex flex-row items-center text-white text-sm font-bold w-full justify-between">
                                <div className="flex flex-row gap-2 items-center">
                                    ...
                                    <label>Nộp bài lúc: </label>
                                </div>
                                <label>17:00 25-12-2025</label>
                            </div>
                            <div className="flex flex-row items-center text-white text-sm font-bold w-full justify-between">
                                <div className="flex flex-row gap-2 items-center">
