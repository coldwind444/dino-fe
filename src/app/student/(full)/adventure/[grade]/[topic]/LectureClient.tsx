...
import { faAngleDoubleRight, faArrowLeft, faArrowRight, faBook, faClose, faCoins, faGift, faGraduationCap, faStar } from "@fortawesome/free-solid-svg-icons";
    ...
    return (
        <div className="h-screen w-screen relative overflow-hidden">
            <Confetti width={window.innerWidth} height={window.innerHeight}
                className={clsx(isCelebrating ? 'opacity-100' : 'opacity-0', 'transition-opacity duration-200')} />
            <Image
            ...
            <div className="absolute h-full w-full flex flex-col gap-[10px]">
                ...
                <AnimatePresence mode="wait">
                    ...
                    {mode === MODE.FINISH &&
                        // Finish Mode View
                        <motion.div key="finish-popup"
                            initial={{ opacity: 0, scale: 0.5 }}
                            animate={{ opacity: 1, scale: 1 }}
                            exit={{ opacity: 0, scale: 0.5 }}
                            transition={{ duration: 0.5, ease: "easeInOut" }}>
                            <div className="h-[95vh] w-[45vw] bg-[rgba(255,255,255,0.4)] rounded-[20px] ml-auto mr-auto 
                                                -translate-y-14 flex items-center justify-center">
                                <div className="h-[90%] w-[85%] rounded-[20px] bg-white shadow-[0_25px_50px_rgba(0,0,0,0.25)] flex flex-col">
                                    {/** Header */}
                                    <div className="rounded-tl-[20px] rounded-tr-[20px] h-[32%] w-full
                                                    bg-gradient-to-r from-0% from-[#5946E5] to-100% to-[#AB3AED]
                                                    flex flex-row items-center justify-between">
                                        <Image src={flags} alt="" height={150} width={150} />
                                        <div className="flex flex-col items-center justify-center gap-1">
                                            <Image src={trophy} alt="" height={100} width={100} />
                                            <label className={clsx("text-white font-bold mt-2", coiny.className, "text-3xl")}>
                                                CHÚC MỪNG
                                            </label>
                                        ...
                                        <Image src={flags} alt="" height={150} width={150} className="scale-x-[-1]" />
                                    </div>
                                    {/** Body */}
                                    <div className="flex flex-1 flex-col py-3 px-5 gap-3 items-center">
                                        ...
                                        <div className="h-[50%] w-full bg-[#EFF6FF] rounded-[10px] py-5 px-10 flex flex-col gap-5">
                                            <div className="flex flex-row gap-7 items-center">
                                                <div className="aspect-square h-12 bg-[#7C3AED] rounded-full flex items-center 
                                                                justify-center text-white text-[20px]">
                                                    <FontAwesomeIcon icon={faStar} />
                                                </div>
                                                <div className={clsx("flex flex-col", roboto.className)}>
                                                    <label className="text-[#4B5563] text-xs">Khối lớp</label>
                                                    <label className="text-[#1F2937] text-[16px] font-bold">Lớp 1</label>
                                                </div>
                                            </div>
                                            <div className="flex flex-row gap-7 items-center">
                                                <div className="aspect-square h-12 bg-[#4F46E5] rounded-full flex items-center 
                                                                justify-center text-white text-[20px]">
                                                    <FontAwesomeIcon icon={faBook} />
                                                </div>
                                                <div className={clsx("flex flex-col", roboto.className)}>
                                                    <label className="text-[#4B5563] text-xs">Chủ đề</label>
                                                    <label className="text-[#1F2937] text-[16px] font-bold">Cộng trừ nhân chia cơ bản</label>
                                                </div>
                                            </div>
                                            <div className="flex flex-row gap-7 items-center">
                                                <div className="aspect-square h-12 bg-[#10B981] rounded-full flex items-center 
                                                                justify-center text-white text-[20px]">
                                                    <FontAwesomeIcon icon={faGraduationCap} />
                                                </div>
                                                <div className={clsx("flex flex-col", roboto.className)}>
                                                    <label className="text-[#4B5563] text-xs">Bài học</label>
                                                    <label className="text-[#1F2937] text-[16px] font-bold">Phép cộng</label>
                                                </div>
                                            </div>
                                        </div>
                                        {/** Score and Reward */}
                                        <div className="flex flex-row gap-2 h-[20%] w-full">
                                            <div className="h-full w-1/2 rounded-[10px] text-white flex flex-row gap-12 px-5 items-center
                                                            bg-gradient-to-br from-0% from-[#F59E0B] to-100% to-[#F97316]">
                                                <div className="flex flex-col items-center justify-center gap-1">
                                            ...
                                            <div className="h-full w-1/2 rounded-[10px] text-white flex flex-row gap-10 px-5 items-center
                                                            bg-gradient-to-br from-0% from-[#EC4899] to-100% to-[#7C3AED]">
                                                <div className="flex flex-col items-center justify-center gap-1">
                                                ...
                                                <div className="font-medium text-3xl flex flex-row items-center">
                                                    <Image src='https://res.cloudinary.com/dirr7ovdh/image/upload/v1761541691/crystal_x9l493.svg'
                                                        height={30} width={30} alt="" className="inline-block mr-2" />
                                                    500
                                                </div>
                                            </div>
                                        </div>
                                        {/** Continue Button */}
                                        <div className="flex flex-row h-[50px] text-white items-center justify-center w-2/3 ml-auto mr-auto
                                                        cursor-pointer hover:opacity-90 transition-all duration-200
                                                        bg-[#4F46E5] rounded-[15px] px-10 gap-5 mt-3">
