...
export function TimeCard({ username }: { username: string }) {
  ...
  return (
    <div className="relative w-[270px] h-[170px]">
      <div className="absolute inset-0 bg-[#FED876] rounded-[15px] translate-x-[4px] translate-y-[4px]" />
...
export default function StudentHome({ lessons }: StudentHomeProps) {
  const username = "Tân";
  console.log("Lessons prop:", lessons);
  console.log("Grade 1 topics:", lessons?.["1"]);
  console.log("First topic:", lessons?.["1"]?.[0]);
  return (
    <div className="w-full h-full p-6 sm:p-10 pl-[63px] pr-[69px] ">
  ...
  <div className="relative inline-block p-[4px] rounded-[40px] shadow-md bg-[#1DA492]">
    ...
    >
      ...
      {/* Main Area */}
      <div className="mt-8 grid grid-cols-1 lg:grid-cols-12 gap-6 items-start max-w-[900px] w-full">
        {/* Lesson Card */}
  ...
  <div className="relative h-[426px]">
    ...
    >
      ...
      <div className={clsx(
        ...
        <aside className="lg:col-span-4 w-[590px] h-fit">
          <div className="">
            <h5 className="font-semibold">Ôn lại kiến thức</h5>
            <div className="mt-3 flex flex-col gap-3 h-[400px] overflow-y-auto pr-2">
