...
import { faBriefcaseClock, faChalkboard, faFlaskVial, faPlay, faRotateRight } from "@fortawesome/free-solid-svg-icons";
...
export default function StudentHome() {
    ...
    return (
        <div className="w-screen min-h-screen p-6 sm:p-10 pl-[63px] pr-[69px] flex flex-col">
            {!entranceTestDone && <div className="absolute h-15 w-15 top-25 right-5 cursor-pointer hover:brightness-110 z-20"
