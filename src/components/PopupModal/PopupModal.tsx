...
export const MODAL_TYPES = {
    SEND: { themeColor: '#3B84F2', message: 'Bạn có chắc chắn muốn nộp bài không ?', icon: faPaperPlane },
    WARNING: { themeColor: '#FF9600', message: 'Bài làm hiện tại của bạn sẽ được lưu lại. \n Bạn có chắc chắn muốn thoát không ?', icon: faWarning }
}
    ...
    return (
        <AnimatePresence>
            <motion.div
                ...
                className="h-screen w-screen bg-[rgba(0,0,0,0.5)] flex items-center justify-center absolute top-0 left-0"
            >
                <motion.div
                ...
                >
                    ...
                    <p className={clsx("text-wrap text-center w-[85%] text-xl font-bold", baloo.className)}>
