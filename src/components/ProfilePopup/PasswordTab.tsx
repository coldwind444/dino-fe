        ...
        <>
            ...
            <div className="mb-6 space-y-2 text-sm text-gray-600">
                <div className="flex items-center gap-2">
                    {passwordData.newPassword.length >= 8 && (
                        <FontAwesomeIcon icon={faCheck} className="w-3 h-3 text-[#1ABC9C]" />
                    )}
                    <span className={passwordData.newPassword.length >= 8 ? "text-[#1ABC9C] italic" : "text-gray-600"}>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className={/[A-Z]/.test(passwordData.newPassword) ? "text-[#1ABC9C] italic" : "text-gray-600"}>
                        *Có chứa chữ in hoa
                    </span>
                </div>
                <div className="flex items-center gap-2">
                    ...
                    <span className={/[0-9]/.test(passwordData.newPassword) ? "text-[#1ABC9C] italic" : "text-gray-600"}>
                        *Có chứa số
                    </span>
                </div>
                <div className="flex items-center gap-2">
                    ...
                    <span
                        className={
                            /[!@#$%^&*(),.?":{}|<>]/.test(passwordData.newPassword) ? "text-[#1ABC9C] italic" : "text-gray-600"
                        }
                    >
            ...
            <button
                disabled={!isValid}
                className={`w-full py-3 rounded-xl font-semibold text-base transition-colors ${isValid
